...
export function AuthFeedback({ message, type, onClose }: AuthFeedbackProps) {
  ...
  return (
    <div
      className={`fixed left-1/2 top-6 z-50 w-[min(92vw,560px)] -translate-x-1/2 rounded-2xl border px-4 py-3 shadow-[0_20px_50px_rgba(0,0,0,0.18)] backdrop-blur ${isSuccess
    ...
    >
      <div className="flex items-start gap-3">
        <div
          className={`mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full ${isSuccess ? "bg-emerald-100 text-emerald-700" : "bg-rose-100 text-rose-700"
            }`}
        >
