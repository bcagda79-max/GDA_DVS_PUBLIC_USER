...
export function BackgroundPaths({
  ...
  if (mode === "background") {
    return (
      <div
        className={cn("absolute inset-0 overflow-hidden pointer-events-none light-hide-bg", className)}
        style={{ backgroundColor: "#060D14" }}
      >
        <div className="absolute inset-0 bg-[#060D14]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_55%_at_50%_0%,rgba(201,168,76,0.14),transparent)] light-hide" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_50%_40%_at_20%_60%,rgba(27,67,50,0.12),transparent)] light-hide" />
        <div className="absolute inset-0 opacity-[0.025] [background-image:repeating-linear-gradient(45deg,rgba(255,255,255,0.8)_0_1px,transparent_1px_28px)] light-hide" />
        <div className="absolute inset-0 opacity-60 light-hide">
          <FloatingPaths position={1} />
          <FloatingPaths position={-1} />
        </div>
        <div className="absolute bottom-0 left-0 right-0 h-64 bg-gradient-to-t from-[#060D14] to-transparent light-hide" />
      </div>
    );
  }
